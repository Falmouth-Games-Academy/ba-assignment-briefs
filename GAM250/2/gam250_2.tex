...
In this assignment, you will work as an individual to develop a game or a resuable component that can be uses in a game. This will explore the topic you picked for assignment 1. This can be related to your group project or something you want to explore for your own portfolio.
...
\begin{enumerate}[label=(\Alph*)]
    \item \textbf{Implement}, a small prototype that shows progress on your topic:
		...
		\end{enumerate}
    \item \textbf{Implement} an improved prototype:
    	\begin{enumerate}[label=\roman*.]
...
To complete Part A, prepare a practical demonstration of the game controller. Ensure that the source code and related assets are pushed to GitHub and a pull request is made prior to the scheduled viva session. Then, attend the scheduled viva session. 
