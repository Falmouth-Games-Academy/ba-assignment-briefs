...
In this assignment, you will work as an individual to develop a small game and then integrate an Ardunio to control some elements of the game (e.g. a button to toggle lights, a slider to control strafing etc) 
